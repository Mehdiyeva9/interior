...
class ProductContent(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='content')
...
class Wishlist(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='user_favori_items')
...
class Savelist(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='user_save_items')
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='product_save_items')
    created_at = models.DateTimeField(auto_now_add=True)
...
class SiteSettings(models.Model):
    ...
    opening_image = models.ImageField(upload_to="site_images/", blank=True, null=True)
